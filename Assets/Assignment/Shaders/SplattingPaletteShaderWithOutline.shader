Shader "Custom/Texture Splatting Palette With Outline"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 MyFragmentProgram(Interpolators i) : SV_TARGET
            {
                ...
                baseColor.rgb = color;
                baseColor.a = clamp(
                    mainBackColorA + splat0Color.r + splat0Color.g + splat1Color.g + splat1Color.b + splat1Color.r +
                    mainColorA + lineColor.a, 0, 1) * i.vertexColor.a;
                return baseColor;
            }
            ENDCG
        }
